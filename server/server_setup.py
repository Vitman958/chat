...
def create_handler(users, server_name, handle_read, room_manager, rate_limiter, command_handler, database_manager, auth_manager):
    async def handle_client(reader, writer):
        try:
            ...
            read_task = asyncio.create_task(
                handle_read(reader, writer, nick_name, stop_event, users, room_manager, rate_limiter, command_handler, database_manager, auth_manager)
            )
